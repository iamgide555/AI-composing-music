<template>
    <div>
        ...
        <div id="piano">
            ...
            <div id="black">
                <div id="b49d" class="b" @mousedown="start('a49')" @mouseup="stop('a49')" style="left: 26px;"></div>
                <div id="b50d" class="b" @mousedown="start('a50')" @mouseup="stop('a50')" style="left: 40px;"></div>
                <div id="b52d" class="b" @mousedown="start('a52')" @mouseup="stop('a52')" style="left: 88px;"></div>
                <div id="b53d" class="b" @mousedown="start('a53')" @mouseup="stop('a53')" style="left: 102px;"></div>
                <div id="b54d" class="b" @mousedown="start('a54')" @mouseup="stop('a54')" style="left: 116px;"></div>
                <div id="b56d" class="b" @mousedown="start('a56')" @mouseup="stop('a56')" style="left: 164px;"></div>
                <div id="b57d" class="b" @mousedown="start('a57')" @mouseup="stop('a57')" style="left: 178px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b81d" class="b" @mousedown="start('a81')" @mouseup="stop('a81')" style="left: 226px;"></div>
                <div id="b87d" class="b" @mousedown="start('a87')" @mouseup="stop('a87')" style="left: 240px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b69d" class="b" @mousedown="start('a69')" @mouseup="stop('a69')" style="left: 254px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b84d" class="b" @mousedown="start('a84')" @mouseup="stop('a84')" style="left: 302px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b89d" class="b" @mousedown="start('a89')" @mouseup="stop('a89')" style="left: 316px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b73d" class="b" @mousedown="start('a73')" @mouseup="stop('a73')" style="left: 364px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b79d" class="b" @mousedown="start('a79')" @mouseup="stop('a79')" style="left: 378px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b80d" class="b" @mousedown="start('a80')" @mouseup="stop('a80')" style="left: 392px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b83d" class="b" @mousedown="start('a83')" @mouseup="stop('a83')" style="left: 440px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b68d" class="b" @mousedown="start('a68')" @mouseup="stop('a68')" style="left: 454px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b71d" class="b" @mousedown="start('a71')" @mouseup="stop('a71')" style="left: 502px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b72d" class="b" @mousedown="start('a72')" @mouseup="stop('a72')" style="left: 516px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b74d" class="b" @mousedown="start('a74')" @mouseup="stop('a74')" style="left: 530px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b76d" class="b" @mousedown="start('a76')" @mouseup="stop('a76')" style="left: 578px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b90d" class="b" @mousedown="start('a90')" @mouseup="stop('a90')" style="left: 592px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b67d" class="b" @mousedown="start('a67')" @mouseup="stop('a67')" style="left: 640px; background-image: linear-gradient(0deg, rgb(200, 200, 200) -10px, rgb(15, 15, 15) 12%);"></div>
                <div id="b86d" class="b" @mousedown="start('a86')" @mouseup="stop('a86')" style="left: 654px;"></div>
                <div id="b66d" class="b" @mousedown="start('a66')" @mouseup="stop('a66')" style="left: 668px;"></div>
            </div>
        </div>
        {{checknoteOff}}
    </div>
